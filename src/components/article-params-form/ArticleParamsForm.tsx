		...
		<>
			...
			<aside className={clsx(styles.container, isOpen && styles.container_open)}>
				<form className={styles.form} onSubmit={(e) => {
					...
					<Select selected={wantedArticleState.fontFamilyOption} options={fontFamilyOptions} title='Шрифт' onChange={(selected) => {
						setWantedArticleState({
							...wantedArticleState,
							fontFamilyOption: selected})
					}}></Select>

					<RadioGroup name='font-size' options={fontSizeOptions} selected={wantedArticleState.fontSizeOption} title='Размер шрифта' onChange={(selected) => {
						setWantedArticleState({
							...wantedArticleState,
					...
					<Select selected={wantedArticleState.fontColor} options={fontColors} title='Цвет шрифта' onChange={(selected) => {
						setWantedArticleState({
							...wantedArticleState,
							fontColor: selected
						})
					...
					<Select selected={wantedArticleState.backgroundColor} options={backgroundColors} title='Цвет фона' onChange={(selected) => {
						setWantedArticleState({
							...wantedArticleState,
					...
					<Select selected={wantedArticleState.contentWidth} options={contentWidthArr} title='Ширина контента' onChange={(selected) => {
						setWantedArticleState({
							...wantedArticleState,
